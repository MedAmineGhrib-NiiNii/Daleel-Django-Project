...
class CaseSerializer(serializers.ModelSerializer):
    ...
    governorate = serializers.CharField(source="student.governorate", read_only=True)
    ...
    class Meta:
        model = Case
        fields = [
            "id", "student_code", "governorate", "risk_score", "risk_band",
            "status", "status_display", "risk_explanation", "data_completeness",
